...
function validarEntradaNFe(
    ...
    if (!cnpjDestinatario) {
        throw new Error(
            'O XML não possui CNPJ do destinatério.'
        );
    }
                    ...
                    resultado.success
                        ...
                        ? (
                            resultado.temDocumentos
                                ...
                                : 'Nenhum documento novo destinado é empresa.'
                        )
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    error:
                        `tipoEvento inválido. Use um dos: ${Object.keys(DESCRICOES_EVENTO).join(', ')} (210200=Confirmação, 210210=Ciéncia, 210220=Desconhecimento, 210240=Não Realizada).`
                });
            }
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    error:
                        'A quantidade de itens enviados não corresponde é quantidade de itens da NF-e.'
                });
            }
            ...
            if (
                ...
                sefaz = {
                    ...
                    xMotivo:
                        'Entrada sem chave de acesso. A confirmação não foi enviada é SEFAZ.',
                ...
                sefaz.success
                    ...
                    : (
                        sefaz.enviada
                            ...
                            : 'Entrada realizada com sucesso. Estoque atualizado. Não foi enviada manifestação é SEFAZ porque esta entrada não possui chave de acesso.'
                    );
