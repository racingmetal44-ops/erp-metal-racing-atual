    ...
    (req, res) => {
        ...
        try {
            ...
            res.status(201).json({
                ...
                message:
                    'Entrada manual cadastrada para confer?ncia.',
        ...
        try {
            ...
            if (
                ...
                sefaz = {
                    ...
                    xMotivo:
                        'Entrada sem chave de acesso. A confirma??o n?o foi enviada ? SEFAZ.',
            ...
            const mensagem =
                sefaz.success
                    ...
                    ? 'Entrada realizada com sucesso. Estoque atualizado. Confirma??o da Opera??o aceita pela SEFAZ.'

                    : (
                        sefaz.enviada

                            ? 'Entrada realizada com sucesso. Estoque atualizado, mas a Confirma??o da Opera??o n?o foi aceita pela SEFAZ.'

                            : 'Entrada realizada com sucesso. Estoque atualizado. N?o foi enviada manifesta??o ? SEFAZ porque esta entrada n?o possui chave de acesso.'
                    );
