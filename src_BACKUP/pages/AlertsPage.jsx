...
export default function AvisosPage() {
  ...
  function mostrarNotificacao(aviso) {
    ...
    // Auto-esconder apés 10 segundos
    setTimeout(() => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-400">
              Centralizaééo dos alertas créticos e pendéncias.
            </p>
          </div>
      ...
      {mostrarForm && (
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">Nºvel de urgéncia</label>
      ...
      {/* NOTIFICAééO FLUTUANTE COM SIRENE */}
      {notificacaoAtiva && (
