...
const PCPPage = () => {
  ...
  const setores = [
    ...
    { id: 2, nome: 'Corte a Laser', cor: '#0dcaf0', icon: '??' },
  ...
  const fetchStats = async () => {
    try {
      ...
      console.error('Erro ao buscar estatésticas:', error);
    }
  };
  ...
  return (
    <div className={styles.pcpContainer}>
      ...
      {/* PAINEL DE SETORES - VISéVEL SEMPRE */}
      <div style={{
        background: 'white',
        borderRadius: '12px',
        padding: '16px',
                  ...
                  >
                    <div className={styles.orderHeader}>
                      <div className={styles.orderTitle}>
                        ...
                        {isDelayed && (
                          <span className={styles.badge} style={{ background: '#dc3545' }}>?? Atrasado</span>
                        )}
                      </div>
            ...
            <form onSubmit={createOrder}>
              ...
              <div className={styles.formGroup}>
                ...
                <small style={{ color: '#6c757d', fontSize: '12px' }}>
                  Escolha em qual setor a produção vai comeéar
                </small>
              </div>
