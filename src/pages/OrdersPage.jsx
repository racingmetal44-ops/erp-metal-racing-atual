    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          {[
            { key: 'shopee', label: 'Shopee', icon: '🛍️', count: newOrdersBySource.shopee },
                ...
                {expandedOrders.has(order.id) && (
                  <div className="border-t border-slate-800 p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                      ...
                      <div>
                        <p className="text-xs text-slate-500">Unidade de Negócio</p>
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="border-b border-slate-800 text-left text-xs text-slate-500">
                              ...
                              <th className="pb-2 text-right">Preço Lista</th>
