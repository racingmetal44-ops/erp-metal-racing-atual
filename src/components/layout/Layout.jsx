...
const navItems = [
  ...
  { to: '/quadro-producao', label: 'Quadro de Produção', icon: ClipboardList },
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 rounded-xl px-3 py-2 text-sm transition ${
                    isActive
                      ? 'bg-orange-500/20 text-orange-300 shadow-[inset_0_0_0_1px_rgba(249,115,22,0.12)]'
