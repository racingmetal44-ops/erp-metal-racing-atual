...
// =========================================================
// CAMADA éNICA DE CARREGAMENTO DO CERTIFICADO A1
// ---------------------------------------------------------
...
export async function carregarCertificado(empresaId) {
    ...
    // Caso contrério, utilizamos o primeiro.
    // -----------------------------------------------------
    ...
    return {
        ...
        // PFX original em meméria
        pfx: pfxBuffer,

        // Senha em meméria para quem realmente precisar
        passphrase: senha,
